...
export class CellBlock {
    ...
    setCenter() {
        ...
        else if ((side["n"].isShip() && side["s"].isShip()) ||
    ...
    setSidesToWater() {
        ...
        if (center.hasSymbol("s") || center.hasSymbol("□")) {
            ...
            else if (side["e"].isShip() && side["w"].isShip()) {
    ...
    correctSides() {
        ...
        if (side["n"].hasSymbol("v") || side["n"].hasSymbol("o"))
            side["n"].setValue(CellValue.ship);
        if (side["e"].hasSymbol("<") || side["e"].hasSymbol("o"))
            side["e"].setValue(CellValue.ship);
        if (side["s"].hasSymbol("^") || side["s"].hasSymbol("o"))
            side["s"].setValue(CellValue.ship);
        if (side["w"].hasSymbol(">") || side["w"].hasSymbol("o"))
...
//# sourceMappingURL=cell-block.js.map