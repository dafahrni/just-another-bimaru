...
export class GameDefinition {
    static default(index = 0) {
        const definitions = [
            new GameDefinition(new Labels([2, 3, 2, 3, 4, 2, 2, 2], [5, 1, 3, 1, 4, 1, 2, 3]), [
                new Cell(new Position(7, 1), CellValue.single),
                new Cell(new Position(4, 3), CellValue.center),
            ]),
            new GameDefinition(new Labels([1, 6, 1, 1, 2, 0, 3, 1, 3, 2], [1, 2, 3, 3, 0, 4, 1, 3, 2, 1]), [
            ...
            new GameDefinition(new Labels([1, 2, 1], [0, 3, 0, 1]), [
    ...
    static from(labels, predefinedCells) {
        return new GameDefinition(labels, predefinedCells);
    }
