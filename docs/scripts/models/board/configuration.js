...
export class Configuration {
    static default(index = 0) {
        const definitions = [
            new Configuration(new Labels([2, 3, 2, 3, 4, 2, 2, 2], [5, 1, 3, 1, 4, 1, 2, 3]), [
                new Cell(new Position(7, 1), CellValue.single),
                new Cell(new Position(4, 3), CellValue.center),
            ]),
            new Configuration(new Labels([1, 6, 1, 1, 2, 0, 3, 1, 3, 2], [1, 2, 3, 3, 0, 4, 1, 3, 2, 1]), [
            ...
            new Configuration(new Labels([1, 2, 1], [0, 3, 0, 1]), [new Cell(new Position(0, 2), CellValue.water)], ShipSet.parse("1|1,2|0,3|1,4|0")),
        ];
    ...
    static extract(field, basedOnNoneEmptyCells = true) {
